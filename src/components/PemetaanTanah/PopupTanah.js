export const getTanahPopupHTML = (item, tanahData, sertifikatData) => {
  const comparisonInfo =
    tanahData.luasTanah && item.luas_tanah
      ? `
          <div class="mt-3 p-3 bg-gray-50 rounded-md space-y-3">
              ...
              <div class="grid grid-cols-2 gap-2 text-xs">
                  <div class="bg-white p-2 rounded">
                      ...
                      <div>${tanahData.luasTanah} m²</div>
                  </div>
                  <div class="bg-white p-2 rounded">
                      <div class="font-medium">Pemetaan</div>
                      <div>${item.luas_tanah} m²</div>
                  </div>
      ...
      <div class="bg-gray-50 p-4 rounded-md space-y-3">
        ...
        <div class="flex items-center text-sm text-gray-600">
          ...
          <span>
            ...
            ${
              tanahData.luasTanah
                ? new Intl.NumberFormat("id-ID").format(tanahData.luasTanah) +
                  " m²"
                : "Tidak tersedia"
            }
          </span>
