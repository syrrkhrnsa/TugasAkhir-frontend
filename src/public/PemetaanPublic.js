...
<div class="mb-4">
            ...
            <div class="mb-2 p-2 bg-gray-100 rounded">
              <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <button 
                    onclick="event.stopPropagation(); window.dispatchEvent(new CustomEvent('showDokumenPopup', { detail: '${sertifikat.id_sertifikat}' }));"
  ...
  useEffect(() => {
    const handleShowDokumenPopup = (event) => {
      setSelectedSertifikat(event.detail);
      setShowDokumenPopup(true);
    };

    window.addEventListener('showDokumenPopup', handleShowDokumenPopup);
    
    return () => {
      window.removeEventListener('showDokumenPopup', handleShowDokumenPopup);
    };
  }, []);
